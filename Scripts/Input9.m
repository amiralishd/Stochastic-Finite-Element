function [Inp] = Input9()
% Input file
% This is the 1st example from the lectures 18-19 on The Polynomial Approach
Inp = struct('Inp',1);
...
Inp.Mem = [1 1 2 2 3 1 1 1 0 1 1 0
           2 2 3 2 3 1 1 1 0 1 1 0];
